      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl lg:max-w-6xl mx-auto">
          <div className="text-center mb-16 sm:mb-20">
            <motion.div 
              className="relative inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 mb-6 sm:mb-8 bg-blue-100 rounded-full text-primary"
            ...
            <motion.h2 
              className="text-3xl sm:text-4xl font-bold mb-4 sm:mb-5 text-gray-900 bg-clip-text text-transparent bg-gradient-to-r from-primary to-blue-700"
          ...
          <div className="relative">
            ...
            <motion.div 
              className="absolute left-1/2 transform -translate-x-1/2 h-full hidden sm:block"
              initial={{ height: 0 }}
              whileInView={{ height: "100%" }}
              viewport={{ once: true }}
              transition={{ duration: 1.5, ease: "easeOut" }}
            >
              <div className="w-0.5 sm:w-1 h-full bg-gradient-to-b from-blue-300 to-indigo-300 rounded-full" />
            </motion.div>
            
            {/* Workflow items */}
            <div className="space-y-20 sm:space-y-24 md:space-y-28 pt-8 sm:pt-10">
              {activeTab === "admin" ? (
                // Admin workflow
                <div>
                  <WorkflowItem 
